<?php
	$_title = "Тестовая главная страница";
	$_h1 = "Информация";
	$_year = date(Y);
?>
...
<body>
	<div id="content">
		...
		<div id="footer">
		      <p>Copyright &copy; <em>minimalistica</em> &middot; Design: Luka Cvrk, <a href="http://www.solucija.com/" title="Free CSS Templates">Solucija</a></p><?=$_year; ?>
		</div>	
	</div>
</body>
</html>